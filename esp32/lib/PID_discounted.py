...
class PID(object):
    ...
    def __init__(
        ...
        self.gammai, self. gammad = gammai, gammad
    ...
    def __call__(self, input_, dt=None):
        ...
        self._integral = (self.Ki * self.unit) * error * dt + self.gammai * self._integral
        self._integral = _clamp(self._integral, self.output_limits)  # Avoid integral windup

        self._derivative = self.gammad * self._derivative - (1-self.gammad) * (self.Kd / self.unit) * d_input / dt
